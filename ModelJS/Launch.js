...
function Authenticate()
{
	...
	//{
		FHIR.oauth2.authorize({
			...
			"scope": "user/Appointment.write user/Appointment.read user/Patient.read user/Patient.write user/Slot.read user/Condition User/Observation patient/Condition patient/Observation online_access openid profile",
