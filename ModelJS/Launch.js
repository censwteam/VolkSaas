			 ...
			 complete: function () {
				 ...
				 if (PatientID > 0) {
					$.ajax({
						...
						url: "https://fhir-ehr.sandboxcerner.com/dstu2/0b8a0111-e8e6-4c26-a91c-5069cbc6b1ca/Condition?patient=" + PatientID +"&date=eq" + $("#searchStartDate").val() + "&_sort=lastUpdated",
						dataType: "json",
						success: function (response) {
						var stringfyJsonResponse = JSON.stringify(response);
						var parseInfo = JSON.parse(stringfyJsonResponse);
